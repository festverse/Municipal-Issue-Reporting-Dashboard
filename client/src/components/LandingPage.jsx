            ...
            <div className="absolute top-0 left-0 pointer-events-none overflow-visible w-full h-[450px]">
              <svg viewBox="0 0 1200 450" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full overflow-visible">
                <defs>
                  ...
                  <filter id="wave_shadow" x="-50%" y="-50%" width="200%" height="200%">
                    <feDropShadow dx="0" dy="12" stdDeviation="16" floodColor="#0284c7" floodOpacity="0.2" />
                  </filter>
                  <filter id="box_shadow" x="-50%" y="-50%" width="200%" height="200%">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center gap-2">
              <span className="text-2xl font-logo font-extrabold text-white">Civic Portal</span>
            </div>
