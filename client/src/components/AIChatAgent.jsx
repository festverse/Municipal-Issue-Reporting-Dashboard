  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end pointer-events-none">
      ...
      <div 
        ...
        className={`absolute bottom-0 right-0 mb-3 w-[380px] sm:w-[440px] h-[540px] bg-white rounded-3xl shadow-2xl border border-slate-200/80 flex flex-col overflow-hidden transition-all duration-300 ease-in-out origin-bottom-right ${
      ...
      <button
        ...
        className={`absolute bottom-0 right-0 group flex items-center gap-3 pl-4 pr-5 py-3.5 bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 hover:from-blue-700 hover:via-indigo-700 hover:to-violet-700 text-white rounded-full shadow-2xl hover:shadow-indigo-500/50 transition-all duration-300 transform active:scale-95 border border-white/20 whitespace-nowrap ${
