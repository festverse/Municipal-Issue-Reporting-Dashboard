          ...
          <div className="mb-8 p-5 bg-gradient-to-br from-slate-50 to-blue-50/50 border border-slate-200/80 rounded-2xl shadow-sm relative z-20 pointer-events-auto cursor-default select-none">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 cursor-default select-none">
              <button 
                ...
                className="py-2.5 px-3 text-xs font-semibold bg-white border border-slate-200 text-slate-700 rounded-xl hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all shadow-sm active:scale-95 flex items-center justify-center gap-1.5 cursor-pointer select-none relative z-20 pointer-events-auto"
              >
                <Wrench className="w-4 h-4 text-slate-600 pointer-events-none" />
                <span className="pointer-events-none select-none">Fill Engineer Data</span>
              </button>
              <button 
                type="button" 
                ...
                className="py-2.5 px-3 text-xs font-semibold bg-white border border-slate-200 text-slate-700 rounded-xl hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all shadow-sm active:scale-95 flex items-center justify-center gap-1.5 cursor-pointer select-none relative z-20 pointer-events-auto"
              >
                <User className="w-4 h-4 text-slate-600 pointer-events-none" />
                <span className="pointer-events-none select-none">Fill Citizen Data</span>
              </button>
            </div>
          </div>
