...
export default function GovPolicy() {
  ...
  const policies = [
    { id: 1, title: 'Municipal Smart Infrastructure Framework 2026', category: 'Infrastructure', code: 'POL-2026-INFRA', status: 'Enacted', date: 'Effective June 1, 2026', image: 'https://images.unsplash.com/photo-1542013936693-88937e862b50?auto=format&fit=crop&w=600&q=80', desc: 'Sets mandatory IoT sensor inclusion and automated AI dispatch response standards for all new road, lighting, and drainage developments within city limits.' },
