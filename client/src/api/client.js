...
Always be highly professional, empathetic, encouraging, and clear. Format answers beautifully with clear headings, bullet points, and actionable engineering/civic advice.`;
  ...
  } else if (msg.includes('made') || msg.includes('make') || msg.includes('creator') || msg.includes('developer') || msg.includes('who has') || msg.includes('build') || msg.includes('author')) {
    return `### 👨‍💻 Developed by Festverse\n\nThis entire **Municipal Issue Reporting Dashboard** was envisioned, engineered, and developed by **Festverse**.\n\n* **Architectural Vision**: The platform was engineered as an ultra-premium, full-stack municipal telemetry portal to eliminate friction between citizens and local government bodies.\n* **Modern Tech Stack**: Built with React, Tailwind CSS, Lucide Icons, Leaflet Spatial Mapping, Node.js/Express, and robust AI orchestration.\n* **State-of-the-Art UI/UX**: Features a fully immersive dark theme system, bi-directional voice interaction, dynamic chat view toggles, and seamless responsive design.\n\n**💡 Check out more cutting-edge projects and repositories on GitHub at [github.com/festverse](https://github.com/festverse)!**`;
  } else if (msg.includes('really ai') || msg.includes('scripted') || msg.includes('bot') || msg.includes('real ai') || msg.includes('how do you work') || msg.includes('are you ai')) {
    return `### 🧠 AI Orchestration & Hybrid Architecture\n\nThat is an excellent technical question! I operate on a **Hybrid AI Orchestration Architecture** designed for maximum reliability:\n\n1. **🟢 Live LLM Backend Mode**: When connected to our live Node.js/Express backend (` + '`' + `${BASE_URL}` + '`' + `), I route your prompts directly to advanced generative AI models (like Gemini/OpenAI) for fully dynamic, contextual civic reasoning.\n2. **⚡ Edge Fallback Mode**: When running as a standalone client-side application or during network disconnects, I instantly fall back to an intelligent, high-speed heuristic matching engine. This ensures citizens can *always* receive rapid guidance on essential workflows, emergency reporting, and telemetry navigation without any backend server lag!\n\n**💡 I am fully equipped to process your voice interactions and guide you through every feature of the Civic Portal.**`;
  } else if (msg === 'hi' || msg === 'hello' || msg === 'hey' || msg.includes('good morning') || msg.includes('good evening') || msg.includes('how are you')) {
    return `### 👋 Welcome to the Civic Portal!\n\nHello there! I am your **Chief Municipal AI Advisor** and Senior Civic Engineering Expert. My systems are fully operational and telemetry grids are active.\n\nI am here to assist you with submitting hazard reports, exploring the live AI spatial heatmap, connecting with government departments, or explaining our Civic Rewards program.\n\n**💡 Feel free to ask me a specific question or speak directly using the microphone button below!**`;
  } else {
    return `### 🏛️ Chief Municipal AI Advisor & Engineering Expert\n\nGreetings! I am your AI Advisor and Senior Civic Engineering Expert. I maintain full operational and telemetry oversight across the **Civic Portal**.\n\nHere are key areas where I can provide expert guidance and recommendations:\n1. 📋 **Submitting & Tracking Hazard Reports** (Potholes, Water Leaks, Streetlights, etc.)\n2. 🗺️ **Navigating the Live AI Spatial Heatmap & Telemetry Grid**\n3. 🏛️ **Communicating with Official Government Departments & Engineers**\n4. 🏆 **Earning Civic Rewards, Credits, and Community Badges**\n\n**💡 I couldn't find a direct match for your specific phrasing in my offline knowledge base. Please try asking about 'reporting', 'rewards', 'map', 'departments', or 'developers'!**`;
  }
};
